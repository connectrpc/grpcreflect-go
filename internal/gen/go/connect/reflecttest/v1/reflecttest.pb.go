...
const file_connect_reflecttest_v1_reflecttest_proto_rawDesc = "" +
	"\n" +
	"(connect/reflecttest/v1/reflecttest.proto\x12\x16connect.reflecttest.v1\"*\n" +
	"\n" +
	"Extendable\x12\x16\n" +
	"\x06number\x18\x01 \x02(\x05R\x06number*\x04\b\n" +
	"\x10\x1f\"A\n" +
	"\tDoRequest\x124\n" +
	"\x03ext\x18\x01 \x01(\v2\".connect.reflecttest.v1.ExtendableR\x03ext\"\f\n" +
	"\n" +
	"DoResponse2Z\n" +
	"\vTestService\x12K\n" +
