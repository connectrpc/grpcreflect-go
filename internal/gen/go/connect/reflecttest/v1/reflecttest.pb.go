...
var file_connect_reflecttest_v1_reflecttest_proto_rawDesc = string([]byte{
...
func file_connect_reflecttest_v1_reflecttest_proto_init() {
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: unsafe.Slice(unsafe.StringData(file_connect_reflecttest_v1_reflecttest_proto_rawDesc), len(file_connect_reflecttest_v1_reflecttest_proto_rawDesc)),
			NumEnums:      0,
			NumMessages:   3,
			NumExtensions: 0,
			NumServices:   1,
