...
import (
	...
	v1alpha "github.com/bufbuild/connect-grpcreflect-go/internal/gen/go/connectext/grpc/reflection/v1alpha"
	http "net/http"
	strings "strings"
)
...
// https://acme.com/grpc).
func NewServerReflectionClient(httpClient connect.HTTPClient, baseURL string, opts ...connect.ClientOption) (ServerReflectionClient, error) {
